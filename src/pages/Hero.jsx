        ...
        <>
            <section className="relative min-h-screen flex items-center bg-bg text-text overflow-hidden">
                ...
                <motion.div
                    ...
                    className="container z-10 mx-auto py-30 px-10 pointer-events-none sm:px-10 lg:px-0 flex flex-col items-start gap-6"
                >
                    ...
                    <h1 className="pointer-events-auto font-title text-5xl lg:text-7xl font-extrabold hover:tracking-wide transition-all duration-300">
                        Alina <br />
